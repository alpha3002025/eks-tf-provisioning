...
release_version = "1.33.1-20251212" ## (4) ➝ 1.33.1-20251212
...
node_group_configurations = [
  {
    ...
    spot_enabled        = false
    release_version     = "1.33.1-20251212" ## (12) ➝ 1.33.1-20251212
    disk_size           = 20
  ...
  },
  {
    ...
    spot_enabled        = true
    disk_size           = 20
    release_version     = "1.33.1-20251212" ## (14) 1.30.4-20241024 ➝ 1.33.1-20251212
    ami_type            = "AL2023_x86_64_STANDARD"
    node_instance_types = ["t3.large"]
    node_min_size       = 0
    node_desired_size   = 2
