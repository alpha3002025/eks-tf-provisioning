module "eks" {
  ...
  deploy_ebs_csi_driver                       = local.deploy_ebs_csi_driver      ## (1)
  deploy_pod_identity_agent                   = local.deploy_pod_identity_agent  ## (2)
  pod_identity_agent_version                  = local.pod_identity_agent_version ## (3)
  enabled_node_disk_gp3                       = local.enabled_node_disk_gp3      ## (4)
}
